    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market_type', models.CharField(choices=[('Stock', 'Stock Market'), ('Crypto', 'Cryptocurrency'), ('Forex', 'Foreign Exchange'), ('Commodity', 'Commodity Market')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timeframe', models.CharField(choices=[('1m', '1 Minute'), ('5m', '5 Minutes'), ('15m', '15 Minutes'), ('1h', '1 Hour'), ('1d', '1 Day'), ('1w', '1 Week'), ('1mn', '1 Month')], default='1d', max_length=50)),
                ('datetime', models.DateTimeField()),
